...
class CohortOutputs:
    def __init__(self, simulated_cohort):
        ...
        for patient in simulated_cohort.get_patients():
            ...
            self._strokes.append(patient.get_number_of_stroke())
        ...
        self._sumStat_strokes = StatCls.SummaryStat('number of strokes', self._strokes)
    ...
    def get_mean_strokes(self):
        return self._sumStat_strokes.get_mean()